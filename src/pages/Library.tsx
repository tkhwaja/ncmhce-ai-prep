...
const LibraryModuleDetail = ({ module, onBack }: { module: LibraryModule; onBack: () => void }) => {
  ...
  return (
    <div className="w-full p-4 sm:p-6 space-y-6">
      <div className="fixed left-4 top-16 z-50 md:left-[calc(var(--sidebar-width)+1rem)]">
        <Button variant="ghost" onClick={onBack} className="border border-border bg-background/95 shadow-sm backdrop-blur supports-[backdrop-filter]:bg-background/80">
