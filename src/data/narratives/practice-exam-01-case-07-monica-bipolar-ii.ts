      ...
      questions: [
        {
          ...
          correctAnswer: 1,
          explanation: "Bipolar II requires at least one hypomanic episode and one major depressive episode. The history of distinct hypomanic periods with functional change and decreased need for sleep is the key differentiator.",
        },
        {
          id: "monica-q2",
          questionNumber: 2,
          domain: "Intake/assessment/diagnosis",
          stem: "Which detail most strongly argues against Bipolar I Disorder based on the information provided?",
          options: [
            "She experiences depressive episodes",
            "Her high-energy periods include impulsive spending",
            "There is no history of full manic episode, psychosis, hospitalization, or marked impairment requiring emergency intervention",
            "Her symptoms worsened after an SSRI",
          ],
          correctAnswer: 2,
          explanation: "Bipolar I requires a manic episode. Her high-energy periods appear consistent with hypomania rather than mania because there is no psychosis, hospitalization, or marked impairment of manic severity.",
        },
        {
          id: "monica-q3",
          questionNumber: 3,
          domain: "Professional practice and ethics",
          stem: "The client asks whether you can tell her PCP what medication she should take. What is the most appropriate response?",
          options: [
            "Recommend a mood stabilizer because antidepressant activation occurred",
            "Explain that prescribing is outside your scope, but with consent you can share symptom history and coordinate referral to a psychiatric prescriber",
            "Tell her to restart the SSRI at a lower dose until psychiatry is available",
            "Avoid discussing medication because doing so would be outside counseling entirely",
          ],
          correctAnswer: 1,
          explanation: "Counselors do not prescribe, but they can provide relevant clinical history and coordinate care with prescribers when authorized.",
        },
        {
          id: "monica-q4",
          questionNumber: 4,
          domain: "Treatment planning",
          stem: "What is the best initial counseling plan while psychiatric evaluation is being arranged?",
          options: [
            "Focus on sleep/routine stabilization, mood tracking, safety monitoring, psychoeducation, and CBT-oriented support for depression",
            "Begin intensive behavioral activation without regard to sleep because inactivity is maintaining depression",
            "Use exposure therapy to reduce fear of the diagnosis",
            "Avoid psychotherapy until medication is started",
          ],
          correctAnswer: 0,
          explanation: "Psychotherapy can begin while medication evaluation is arranged. Key early targets include sleep/routine stabilization, psychoeducation, mood tracking, safety, and depressive coping strategies.",
        },
      ],
    },
    {
