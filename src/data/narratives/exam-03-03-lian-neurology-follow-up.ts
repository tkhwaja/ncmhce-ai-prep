...
export const lianNeurologyFollowUpNarrative: Narrative = {
  id: 'exam-03-03-lian-neurology-follow-up',
  title: 'Lian — Neurology Follow-Up',
  ...
  presentingProblem: `You are a licensed mental health counselor in a behavioral health service affiliated with a university neurology center. Lian L., a 29-year-old hospital laboratory technologist, was referred for “episodes of altered awareness under neurological evaluation.” She has had 18 events over five months, including three emergency-department visits. An epilepsy specialist will admit her for video-EEG monitoring in two weeks. The referral asks you to address distress and functioning while the medical evaluation continues, not to determine whether the events are epileptic.

Lian describes a typical episode as an internal wave, distant hearing, narrowing vision, and difficulty speaking, followed by closed eyes and shaking that others describe as irregular. Some events begin with a racing heart or faster breathing, but she usually reports confusion or detachment rather than sudden fear of dying or losing control. She can sometimes hear her fiancé during an event but cannot respond consistently. Events last between four and eighteen minutes, may pause and resume, and leave her tired for hours. They have occurred after conflict, during demanding laboratory work, while waiting in a grocery line, and once at home after a relaxed evening. A coworker’s phone video shows side-to-side head movement and asynchronous arm movement, but a counselor cannot establish seizure type from the recording.

Brain MRI, cardiac testing, metabolic studies, and neurological examination between episodes were unremarkable. A 30-minute routine EEG did not show epileptiform activity, but no habitual event occurred during it. One emergency physician documented “probable stress reaction”; another prescribed levetiracetam pending specialist review. Lian reports irritability since starting it. The neurologist instructed her not to drive and not to work alone around open chemicals or operating centrifuges until evaluation is complete. Lian asks whether she should stop the medication because “nothing electrical showed up.” You explain that medication decisions remain with neurology.

In college, Lian had two panic attacks involving abrupt terror, chest pressure, fear of dying, and an urge to escape. She has not had that pattern in years. She worries before presentations and medical appointments but does not report pervasive anxiety across domains, panic-focused avoidance, obsessions, psychosis, mania, substance use, or an established trauma syndrome. Sleep has become fragmented because she monitors every sensation. She denies deliberately producing symptoms and is offended that her supervisor implied the episodes appear when work becomes difficult.

Lian requested medical leave only after her third emergency visit. Her first nine events predated a corrective-action meeting at work, although leave and a pending grievance now create potential external benefit. She says, “I know that makes me look suspicious. I would trade the leave to have my body back.” There is no observed deception, covert medication manipulation, falsified record, or evidence that she induces attacks. At the same time, absence of detected deception cannot by itself determine whether symptoms are voluntary.

Lian identifies several current stressors: her father’s recovery from a stroke, rotating shifts, conflict with a supervisor, and her mother’s insistence that the family keep health problems private. She rejects the assumption that a hidden trauma must explain the attacks. “Every appointment becomes a hunt for the emotional secret that caused this. Then if I cannot produce one, they think I am lying.”

She denies suicidal or homicidal ideation and has no self-injury history. During one event she fell from a stool and sustained a mild concussion. Her fiancé, Evan, now calls emergency services for every episode and does not let her shower or walk outside alone. Lian appreciates his concern but says their apartment has become “a surveillance unit.” Her immediate goals are an accurate diagnosis, a safe response plan, and as much independence as possible.`,

  mentalStatusObservation: `Lian arrives early, appropriately groomed, and fully oriented. She is attentive, precise, and initially guarded. Speech is fluent and organized. Mood is “angry and scared that no one believes me.” Affect is tense and tearful when prior medical encounters are discussed, with appropriate range elsewhere. There is no psychosis, mania, intoxication, or cognitive disorganization.

She frequently checks her pulse and pauses when noticing tingling, then redirects with prompting. Insight is good regarding impairment and uncertainty; she does not claim certainty about epilepsy or a psychological cause. Judgment is intact in following temporary medical precautions. Lian denies suicidal or homicidal ideation. Current risk centers on injury during episodes, medication and driving questions, occupational exposure, and possible overrestriction rather than intentional self-harm.`,

  familyHistory: `Lian lives with Evan, her fiancé of four years. He is supportive and frightened, having witnessed her fall. With Lian’s authorization, he may participate in event-response planning but does not receive unrestricted session information.

Lian’s parents immigrated from China before she was born. Her mother describes the episodes as “weak nerves from overwork” and fears stigma within their community; her father wants another neurological opinion. Lian worries that clinicians may stereotype an Asian American woman with unexplained symptoms as emotionally repressed or “somatizing.” She wants cultural and family context explored without treating it as a causal shortcut.

There is no known family history of epilepsy. An aunt has panic disorder. Lian’s father has post-stroke motor limitations without seizures. No family suicide is known.`,

  workHistory: `Lian has worked for four years in a hospital microbiology laboratory. Earlier reviews were strong. Rotating shifts and staffing shortages preceded reduced concentration and two documentation errors, neither occurring during an attack. The first episode at work occurred before formal discipline. After later episodes, occupational health placed her on leave pending neurological guidance.

Her duties include handling specimens, using chemicals, operating centrifuges, and occasionally working alone. Lian has filed a grievance alleging that her supervisor mocked her symptoms. She wants eventual return with reasonable safety measures, while the employer and disability carrier request clinical documentation. You clarify that treating symptoms and documenting observed functioning are different from independently determining neurological causation, legal disability, or fitness for every laboratory duty.`,

  intakeSessionSummary: `You validate that Lian’s events and impairment are real regardless of their final classification. You explain that a normal MRI or routine EEG does not mean “nothing happened” and does not by itself establish functional symptoms or exclude epilepsy. The most useful next information includes detailed descriptions from Lian and witnesses, videos when safely available, whether each event type is habitual, medical red flags, and the neurologist’s interpretation of a typical captured event.

With authorization, you coordinate with neurology and occupational health. Until diagnostic clarification, you follow the neurologist’s activity and emergency guidance, assess injury and mental-health risk, and avoid advising medication or driving changes. You also begin examining sleep, anticipatory fear, body monitoring, functional loss, stress, family responses, and Lian’s understanding without assuming these caused the attacks.

Lian agrees that therapy may support coping and function during evaluation but says she will leave if counseling becomes proof that the episodes are fabricated. You review a collaborative treatment frame and explain that factitious disorder and malingering require evidence of intentional production; external incentives or unusual symptoms alone do not establish either.`,
  ...
  sections: [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          stem: 'Lian says, “If the tests are normal, everyone will decide I am faking.” What is the best response?',
          options: [
        ...
        },
        {
          ...
          options: [
            ...
            'Events decline after grounding and occur more often during interpersonal conflict than during periods Lian describes as emotionally neutral',
        ...
        },
        {
          ...
          stem: 'How should the counselor incorporate Lian’s cultural concerns into the assessment?',
          options: [
            ...
            'Invite Lian’s own meanings, examine family and medical-system responses, and negotiate support without assuming that ethnicity, privacy, or emotion caused the attacks',
            ...
            'Prioritize individual sessions until Lian accepts the diagnosis, because early family involvement may strengthen stigma and excessive monitoring',
          ],
          correctAnswer: 1,
          explanation: 'Cultural responsiveness requires inquiry without stereotype. The counselor should ask how Lian understands the events, health, privacy, family roles, and prior clinical encounters; examine the effects of stigma and bias; and collaborate about support. Assuming that emotional restraint has become a physical symptom reproduces the causal shortcut Lian fears. Excluding culture creates a different distortion because evidence is interpreted within relationships and systems. Family involvement may help when Lian authorizes it, but neither automatic exclusion nor automatic inclusion is culturally responsive. The best answer preserves Lian’s authority over her experience while keeping clinical formulation open and evidence based.',
        },
      ],
    },
    {
...
Further assessment does not establish panic disorder, PTSD, a major mood episode, substance involvement, factitious disorder, or malingering. Lian has significant anticipatory anxiety and sleep disruption but no separate full syndrome. Work conflict and disability benefits are relevant contextual data; neither supplies evidence that the attacks are consciously produced.

Lian says, “Part of me is relieved. Part of me hears ‘functional’ as a polite word for imaginary.” Evan accepts the diagnosis but remains hypervigilant. He times every sensation, repeatedly asks whether an attack is beginning, physically holds Lian down when shaking starts, and calls emergency services even when an event matches the neurologist-documented pattern and emergency criteria are absent. He says attention is the only way to prove he believes her.

Lian wants treatment to reduce attacks, but she places equal importance on showering alone, walking to a nearby café, resuming household tasks, and returning to laboratory work safely. She is willing to examine arousal, attention, avoidance, emotion, and learning processes if the counselor does not present any one factor as the hidden cause.`,
      questions: [
        {
          id: 'exam-03-lian-q5',
          questionNumber: 5,
          ...
          options: [
            ...
            'Factitious Disorder imposed on self because Lian seeks a patient role and occupational relief despite repeated negative neurological findings',
        ...
        },
        {
          ...
          stem: 'Which treatment plan best fits Lian’s diagnosis, goals, and current medical guidance?',
          options: [
            ...
            'Begin trauma-focused treatment to identify the dissociated precipitant, adding functional rehabilitation once Lian can connect attacks to emotional triggers',
        ...
        },
        {
          ...
          options: [
            ...
            'Continue emergency activation until Lian has remained event-free for several months, then reduce monitoring as neurological risk becomes negligible',
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            ...
            'Complete the form jointly with Lian so her report, the counselor’s observations, and neurology’s findings are equally represented in each conclusion',
