  ...
  sections: [
    {
      ...
      sectionNarrative: '',
      questions: [
        { id: "erica-q1", questionNumber: 1, domain: "Intake/assessment/diagnosis", stem: `Which detail most strongly supports Prolonged Grief Disorder rather than expected bereavement or Major Depressive Disorder alone?`, options: [`She continues to feel sadness 19 months after her wife’s death`, `Her grief is persistent, impairing, and organized around intense longing, preoccupation with Monique, avoidance of reminders, and difficulty re-engaging in life`, `Her PHQ-9 score is in the moderate range`, `She has kept Monique’s voice mails and personal belongings`], correctAnswer: 1, explanation: `Prolonged Grief Disorder is not diagnosed simply because sadness lasts a long time. The key is persistent, impairing grief centered on yearning/preoccupation and difficulty adapting to life after the death. Depressive symptoms and sentimental items may be present but are not sufficient.` },
        { id: "erica-q2", questionNumber: 2, domain: "Professional practice and ethics", stem: `Erica says, “If I didn’t wake up tomorrow, at least I would get to rest.” Which response is most clinically appropriate?`, options: [`Normalize the statement as common in grief and continue the intake`, `Conduct a direct suicide risk assessment, including intent, plan, means, protective factors, and parenting responsibilities`, `Refer immediately to psychiatry because grief-related death wishes require medication evaluation`, `Begin a safety plan without asking further questions so she does not feel interrogated`], correctAnswer: 1, explanation: `Passive death wishes require direct assessment. The clinician should not dismiss them as grief, jump to psychiatry before assessment, or create a plan without first clarifying risk.` },
        { id: "erica-q3", questionNumber: 3, domain: "Core counseling attributes", stem: `Erica says, “People wonder why I still look like my life ended. The problem is, my life as I knew it did end.” What is the most therapeutic response?`, options: [`“It sounds like people want your grief to look more resolved than it feels inside.”`, `“They may be trying to help you move forward.”`, `“What would moving forward look like if it did not mean betraying Monique?”`, `“Grief can last a long time, but it should not stop your life.”`], correctAnswer: 0, explanation: `The best immediate response validates the pressure and isolation she experiences without rushing her toward meaning-making or change. Option C is clinically useful later but moves a step too quickly.` },
        { id: "erica-q4", questionNumber: 4, domain: "Treatment planning", stem: `Which treatment frame best fits Erica’s presentation?`, options: [`Help her detach from Monique so she can resume parenting and work`, `Support a continuing bond with Monique while gradually restoring functioning, parenting presence, and meaningful engagement`, `Focus only on depressive symptoms because grief-specific work may intensify distress`, `Encourage her to remove Monique’s belongings to reduce avoidance`], correctAnswer: 1, explanation: `Contemporary grief treatment supports adaptive continuing bonds while restoring functioning and future engagement. Detachment, avoidance of grief work, or forced removal of belongings is not clinically appropriate.` },
...
A meaningful shift did occur this week: the client attended one of Malik's basketball games and stayed through the parking-lot conversation afterward. She stated, "I cried on the drive home. But I stayed. I did not disappear from my own son's life to avoid my feelings." She asked you, "How do I help him remember his mom without teaching him that remembering means falling apart?"`,
      questions: [
        { id: "erica-q5", questionNumber: 5, domain: "Counseling skills and interventions", stem: `Erica asks how to help Malik remember Monique without teaching him that remembering means falling apart. What is the best clinical direction?`, options: [`Help her create age-appropriate, ongoing ways to talk about Monique that allow sadness and connection without making either emotion dangerous`, `Recommend that difficult memories be saved for therapy or family rituals rather than daily life`, `Encourage her to focus on positive memories only until Malik is older`, `Suggest family therapy before she continues answering his questions`], correctAnswer: 0, explanation: `Children benefit from honest, age-appropriate conversations and rituals that show grief can be felt and shared. Avoiding painful memories, positivity-only narratives, or delaying all conversation can increase confusion.` },
        { id: "erica-q6", questionNumber: 6, domain: "Core counseling attributes", stem: `After donating three of Monique’s coats, Erica’s mother-in-law accuses her of erasing Monique. What is the most therapeutic response?`, options: [`“Your mother-in-law is grieving too, so her reaction makes sense.”`, `“What did donating those coats mean to you before it became a conflict?”`, `“You may need clearer boundaries with her family.”`, `“Maybe hold off on changing Monique’s belongings until everyone is ready.”`], correctAnswer: 1, explanation: `The counselor should first help Erica clarify the personal meaning of the action. Boundary work may become relevant, but immediately centering the mother-in-law or prescribing delay bypasses Erica’s grief process.` },
        { id: "erica-q7", questionNumber: 7, domain: "Treatment planning", stem: `Erica attends Malik’s basketball game despite intense grief and cries afterward in the car. How should this be understood clinically?`, options: [`As avoidance because she delayed emotional expression until after the event`, `As meaningful restoration-oriented engagement because she stayed present for a valued parenting role while tolerating grief`, `As evidence that her symptoms are primarily depressive rather than grief-related`, `As a sign that she should avoid emotionally loaded child activities until symptoms improve`], correctAnswer: 1, explanation: `The clinical gain is that she remained present in a valued role while grief was active. Crying afterward does not negate progress; it reflects grief being carried rather than avoided.` },
        { id: "erica-q8", questionNumber: 8, domain: "Professional practice and ethics", stem: `Erica asks whether you can speak directly with Malik’s teacher about the family-tree assignment. What is the best response?`, options: [`Agree because the school issue is affecting treatment and parenting`, `Decline because direct school communication would compromise confidentiality`, `Clarify the purpose of contact, discuss whether coaching Erica to communicate herself may better support autonomy, and obtain written authorization if contact occurs`, `Contact the teacher without written authorization as long as you do not share Erica’s diagnosis`], correctAnswer: 2, explanation: `Collateral contact requires a clear purpose and authorization. It is also clinically important to consider whether empowering the client to communicate directly better serves treatment goals.` },
...
She asked a practical question about treatment: "How do I know whether it makes sense to taper therapy? I do not feel done grieving. I do feel more like myself."`,
      questions: [
        { id: "erica-q9", questionNumber: 9, domain: "Counseling skills and interventions", stem: `Erica experiences a symptom spike around the anniversary of the surgery that preceded Monique’s death, but she uses coping strategies and support. What is the most accurate clinical interpretation?`, options: [`The symptom spike suggests unresolved trauma is now primary`, `Anniversary reactions can occur even with meaningful progress, and her response shows improved coping and integration`, `The spike indicates treatment should return to the intake-level stabilization phase`, `The spike shows tapering should be postponed indefinitely`], correctAnswer: 1, explanation: `Anniversary reactions are common and do not automatically indicate relapse or treatment failure. Her use of support and coping strategies is a strong indicator of progress.` },
        { id: "erica-q10", questionNumber: 10, domain: "Intake/assessment/diagnosis", stem: `Malik says, “Missing her and having fun can happen on the same day.” Clinically, this most strongly reflects:`, options: [`Avoidance of deeper grief through positive distraction`, `Adaptive grief integration and a continuing bond with the deceased`, `Premature emotional maturity caused by parentification`, `Denial of the permanence of the death`], correctAnswer: 1, explanation: `The ability to hold grief and joy together reflects adaptive grief integration. It does not suggest denial, avoidance, or parentification based on the information given.` },
        { id: "erica-q11", questionNumber: 11, domain: "Treatment planning", stem: `Erica asks whether it makes sense to taper therapy because she does not feel done grieving but feels more like herself. What is the most appropriate response?`, options: [`Recommend tapering because her PG-13 is below the clinical threshold`, `Continue weekly sessions until she no longer experiences grief-related distress`, `Collaboratively review gains, supports, predictable triggers, parenting needs, and a relapse-prevention plan before deciding on reduced frequency`, `End individual therapy and refer to a bereavement support group`], correctAnswer: 2, explanation: `Tapering should be collaborative and based on functioning, supports, trigger planning, and symptom trends—not the absence of grief or a single score.` },
        { id: "erica-q12", questionNumber: 12, domain: "Core counseling attributes", stem: `Erica says, “Remembering her and building a life without her did not feel like opposite loyalties.” What is the most therapeutic response?`, options: [`“That is a sign your grief is becoming integrated.”`, `“What is it like to feel those two loyalties becoming less divided?”`, `“That means you are ready to move forward without guilt.”`, `“You can use that thought when grief spikes again.”`], correctAnswer: 1, explanation: `The best response deepens the client’s own meaning-making rather than labeling it, overinterpreting readiness, or turning it immediately into a coping statement.` },
