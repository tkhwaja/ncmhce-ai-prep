...
export const marcusPtsdPanicAlcohol: Narrative = {
  id: '25-marcus-ptsd-panic-alcohol',
  title: 'Marcus — PTSD with Dissociative Symptoms, Panic Disorder, and Alcohol Use Disorder',
  ...
  presentingProblem: `You are a licensed mental health counselor in a trauma and substance use clinic. Marcus R., a 41-year-old Black firefighter lieutenant, requests an urgent appointment after encouragement from his wife, Alyssa, and a union peer-support representative. His six EAP visits are for treatment; you were not retained to determine fitness for duty. Marcus immediately asks whether his chief can obtain his diagnosis or notes.

Fourteen months ago, a floor collapsed during an apartment fire, killing Marcus’s colleague Luis and one child. Marcus struck his head, was briefly disoriented, and declined recommended follow-up. Since then he has nightmares, intrusive images, avoidance, guilt, detachment, irritability, sleep disturbance, hypervigilance, and diminished family and recreational involvement. A low-air chirp or wet-ash odor can make the current setting recede while he sees the collapsed hallway, hears Luis, and reaches or crawls as if the rescue is occurring. The episodes are brief, cue linked, and followed by restored context. Separately, he sometimes feels outside his body or experiences the station as unreal while knowing where he is. Between episodes he has organized thought, intact reality testing, and no hallucinations or delusions.

During the past six months Marcus has also experienced abrupt surges of palpitations, chest pressure, shaking, choking, tingling, heat, and fear of death or loss of control. Some follow trauma reminders, but at least five occurred without an evident trauma cue. They peak within minutes. He now checks his pulse and oxygen saturation, avoids exercise alone, chooses routes near hospitals, and persistently anticipates another attack. One urgent-care ECG was reassuring, but he has not completed a broader cardiopulmonary or neurologic evaluation.

Marcus began drinking to sleep after the fire and now consumes five to seven standard drinks most evenings. He frequently exceeds his intended amount, has made three unsuccessful efforts to stop, experiences strong craving, and continues despite worsened nightmares and conflict. He denies morning drinking, previous withdrawal seizure, or alcohol use while on duty. Eleven hours after his last drink, he has tremor, sweating, nausea, and a pulse of 112. Anxiety, early withdrawal, another medical condition, or combined causes remain possible.

Two nights ago a memorial video triggered vivid reliving after approximately eight drinks. Marcus crouched behind a kitchen island calling a mayday, then said, “Maybe one clean exit is the only decision I cannot fail.” He placed the locked case containing his loaded handgun on the table and considered shooting himself for several minutes without opening it. His brother Darius removed the firearm and ammunition for lawful off-site storage. Marcus currently denies intent and another firearm but says he cannot predict how he would think if intoxicated and reliving the fire. He identifies family, crew, and faith as reasons to live and agrees not to drive. Meanwhile, his chief requests notes and a statement that Marcus is safe to return by Friday; Marcus has signed no authorization.` ,

  mentalStatusObservation: `Marcus is neatly groomed, alert, and fully oriented. Speech is coherent and goal directed, becoming faster—but not pressured—when he describes panic. Mood is “ashamed and wired”; affect is constricted, anxious, and intermittently tearful. Thought content includes guilt, hopelessness, recent suicide-specific thinking, and realistic employment concerns. He denies current intent, plan, homicidal ideation, mania, or psychosis.

When a cart alarm sounds, Marcus becomes pale and says the room looks distant. He retains the date and location, follows orientation prompts, and recovers within one minute. Concentration varies, and the causes of recent memory lapses remain uncertain among dissociation, alcohol, sleep loss, panic, and possible head-injury effects. Insight is fair; judgment was impaired while intoxicated and triggered. Recent firearm-related preparation, alcohol use, reexperiencing, uncertain future intent, and autonomic findings outweigh reassurance from his present denial and protective factors.` ,

  familyHistory: `Marcus was raised in a stable working-class family emphasizing faith, service, and reliability. His grandfather drank heavily after military service, and his mother received treatment for recurrent depression. There is no known family history of psychosis, bipolar disorder, suicide death, or withdrawal seizure.

Marcus and Alyssa have been married for 15 years and have a 13-year-old son. Alyssa has monitored his sleep, hidden keys after drinking, and repeatedly checked whether he is “back in the building.” Marcus experiences both care and surveillance. He describes racialized experiences in which quietness was interpreted either as invulnerability or threat, alongside fire-service pressure to remain operational. These concerns may shape disclosure without replacing individualized risk assessment.` ,

  workHistory: `Marcus has worked in fire service for 16 years and was promoted to lieutenant three years ago. Before the collapse, evaluations described calm command and sound risk assessment. Since returning 12 days after the incident, he has traded assignments, declined promotion testing, and used leave after drinking.

Three weeks ago a low-air alarm during a basement fire produced 20 seconds of reliving; Marcus moved toward a blocked room despite a partner’s direction, then reoriented and completed an orderly exit. A later panic surge during equipment inspection led him to request relief. He is now on paid administrative leave pending an independent occupational evaluation. The chief requests diagnosis, prognosis, notes, and clearance, while the union reports a separate fitness process. Marcus recognizes that treatment, employer communication, and fitness determination are related but distinct roles.` ,
  ...
  sections: [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          questionNumber: 2,
          domain: 'Intake/assessment/diagnosis',
          stem: 'What is the best interpretation of Marcus’s episodes of seeing the hallway and hearing Luis?',
          options: [
            ...
            'They are trauma-themed hallucinations within a primary psychotic disorder because Marcus briefly acts on perceptions others cannot verify',
            'They are episodes of depersonalization because Marcus later recognizes the event was not occurring and sometimes views himself externally',
          ],
          correctAnswer: 1,
        ...
        },
        {
          ...
          options: [
            ...
            'Ask Marcus for a narrow authorization and provide a temporary fitness opinion while the independent evaluator completes the formal assessment',
      ...
      questions: [
        {
          ...
          options: [
            ...
            'Accept Marcus’s account without collateral because prior stereotyping makes additional verification likely to reproduce racial and occupational harm',
          ...
          correctAnswer: 2,
          explanation: 'Cultural humility requires examining how bias, role expectations, and realistic employment concerns may shape communication while preserving direct individualized assessment. An identity-blind stance can hide rather than eliminate bias. Conversely, responsiveness does not require abandoning collateral or accepting safety conclusions uncritically. Assuming that Marcus’s identities determine the meaning of silence simply substitutes a new stereotype. The counselor should name possibilities tentatively and privilege Marcus’s contextual meaning.',
        },
        {
          id: 'marcus-q7',
          questionNumber: 7,
          ...
          options: [
            ...
            'Maintain recovery care and safety planning while beginning paced evidence-based trauma work when Marcus can remain engaged and use supports',
        ...
        },
        {
          ...
          stem: 'After appropriate medical review, which intervention most directly addresses Marcus’s panic-maintaining fear of bodily sensations?',
          options: [
            'Begin graded exercise exposure while temporarily permitting scheduled pulse checks, fading them only after Marcus repeatedly records normal readings',
        ...
        },
        {
          ...
          questionNumber: 9,
          domain: 'Professional practice and ethics',
          stem: 'What is the best response to the narrow occupational request and Marcus’s demand for a guarantee?',
          options: [
            'Decline a guarantee, review the authorization with Marcus, and provide only accurate authorized information while preserving the evaluator’s role',
        ...
        },
        {
          ...
          options: [
            ...
            'Plan a two-drink limit with Alyssa present so Marcus can test whether social use differs from solitary trauma-related drinking',
          ...
          correctAnswer: 1,
          explanation: 'The response should respect privacy while linking the decision to Marcus’s recovery goals and recent consequences. He can consider whether to attend, bring support, use a nonclinical refusal, arrange transportation, monitor cravings, and leave early. Universal social avoidance may increase isolation, while a controlled-drinking test at a high-risk event is poorly timed. Peer support can help if Marcus chooses it, but attendance does not require informal workplace monitoring or disclosure.',
        },
      ],
    },
    {
      sessionLabel: 'Eighteenth session',
      sectionNarrative: `Eight months after intake, Marcus remains engaged in coordinated trauma and recovery care. His PCL-5 score fell from 63 to 24, panic attacks occur less than monthly, and he tolerates exercise sensations without routine monitoring. He reports no suicide ideation for seven months; firearms remain with Darius pending separate reassessment. Neuropsychological evaluation found mild attentional variability without enough evidence for a neurocognitive disorder.

An independent occupational clinician approved a graduated return. Marcus completed supervised training and non-command responses without unsafe action. He authorizes a limited treatment summary to the evaluator, not the chief, but wants it to state that his risk is zero.

At an anniversary barbecue, Marcus drank two beers after seven abstinent months. He noticed an urge to buy liquor, called Darius, went home without driving or further use, and informed Alyssa and his recovery counselor the next morning. Alyssa calls it a relapse; Marcus calls it proof of controlled drinking. He briefly considers leaving therapy to prevent documentation. The event requires assessment but does not alone establish catastrophic relapse or safe controlled use.
...
Marcus also describes guilt and betrayal connected to obeying the evacuation order while Luis moved toward the trapped child. He asks whether “moral injury” replaces PTSD. The evaluator requests updated functional observations and whether the alcohol use or drill episode changed recommendations. Marcus asks you to omit the drinking, decide fitness yourself, and connect firearm return to successful work performance.` ,
      questions: [
        {
          id: 'marcus-q11',
          questionNumber: 11,
          domain: 'Treatment planning',
          stem: 'What is the best response to Marcus’s alcohol use at the anniversary event?',
          options: [
            ...
            'Document the event without changing treatment because Marcus sought support before intoxication, driving, suicidality, or additional use occurred',
          ...
          correctAnswer: 3,
          explanation: 'The episode matters because alcohol previously interacted with trauma, suicidality, and firearm risk. Analysis should examine cues, social pressure, decisions, craving, protective actions, current suicide and access risk, and subsequent behavior. Marcus’s early disclosure and help-seeking are strengths but do not prove controlled drinking is safe. Conversely, two drinks do not automatically erase progress or mandate a higher level of care. The response should be proportionate, collaborative, and coordinated.',
        },
        {
          id: 'marcus-q12',
          questionNumber: 12,
        ...
        },
        {
          ...
          questionNumber: 13,
          domain: 'Counseling skills and interventions',
          stem: 'How should moral injury be incorporated into Marcus’s treatment?',
          options: [
            ...
            'Use cognitive restructuring solely to establish that Marcus had no responsibility, postponing betrayal and grief until guilt has resolved',
        ...
        },
        {
          ...
          options: [
            'Omit the alcohol event because off-duty behavior falls outside occupational relevance and Marcus controls all facts after signing an authorization',
