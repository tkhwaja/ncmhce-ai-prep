...
export const naomiAdolescentMedicineReferralNarrative: Narrative = {
  id: 'exam-03-07-naomi-adolescent-medicine-referral',
  title: 'Naomi — Adolescent Medicine Referral',
...
Six days earlier her pulse was 54 and blood pressure 94/60. Today Naomi is pale and reports tunnel vision on standing. Pulse is 47 supine and rises 44 beats after standing; blood pressure is 87/53 and temperature 96.0°F. The counselor does not determine medical stability.

Naomi denies wanting thinness and says weight loss makes her weak and “unrecognizable.” She wants her previous weight, menstruation, and endurance. When texture seems safe, she sometimes chooses the higher-calorie drink. Her mother nevertheless reports label reading, meal photographs, oversized sweatshirts, wellness accounts, and distress over preparation changes. Naomi says she checks allergens, thickness, and prescribed calories; photographs record foods swallowed safely; and sweatshirts address cold. These accounts require assessment, not automatic acceptance.

Naomi reports choking images, seeks reassurance that her lips are not blue, counts about 30 chews, and replays the incident. She denies contamination, harm, taboo, or symmetry obsessions; checking outside meals; and unrelated rituals. She recognizes that near-total solid avoidance is “bigger than the first accident,” but notes that anxiety cannot prove her throat is normal.

The complaint cannot be presumed psychological. For two years, dense food occasionally required water and Naomi finished meals last. She has eczema and seasonal allergies but no completed gastrointestinal or swallowing evaluation. She denies intentional vomiting, compensatory behaviors, binge eating, substance use, suicidal ideation, and self-injury.

Her mother signed consent and wants the counselor to “make her take a bite.” Naomi requests private time and will not speak honestly if every fear is reported. Under the stated rules, a parent consents to ongoing outpatient care, the counselor seeks Naomi's assent, and Naomi receives private time. Caregivers may receive information necessary for safety and their treatment role; other psychotherapy content is protected unless disclosure is legally required. These limits must be explained first.` ,

  mentalStatusObservation: `Naomi is alert, oriented, cooperative, and fatigued. She wears a loose sweatshirt; an unopened nutrition drink sits beside her. Speech is soft, coherent, and goal directed. Mood is “scared and embarrassed”; affect is anxious and constricted. She swallows repeatedly during food discussion without respiratory distress. Thought content centers on choking. There is no psychosis, mania, suicidality, or violent intent. Attention slows during the interview. She recognizes that fear has generalized but cannot identify which sensations are medically significant. Fear compromises nutritional judgment, and the physical findings require immediate medical determination.` ,

  familyHistory: `Naomi lives with both parents and her 12-year-old brother. Meals are the family's main connection. Her mother, raised in South Korea, expresses care through food; Naomi feels guilty when refusal appears rejecting. Her father emphasizes following medical instructions. He demands another bite while her mother blends separate meals and checks Naomi's breathing. This pressure-rescue pattern increases conflict and may maintain fear, although necessary nutrition support is not merely “accommodation.”

Her brother has a peanut allergy, so the family uses labels and emergency plans; Naomi tested negative. Her mother has treated panic disorder. No family eating disorder, OCD, psychosis, suicide, or substance disorder is reported. Cultural meaning, realistic allergy experience, and fear-maintaining behavior require individualized assessment.` ,

  workHistory: `Naomi is an academically strong senior who played varsity tennis. Breakfast now takes over an hour; she eats alone in the health office and misses classes involving food odors. Two grades have declined. She stopped tennis after presyncope and avoids food-centered socializing. A school counselor asks about accommodations, but Naomi has not authorized communication and no request is defined.` ,
      ...
      questions: [
        {
          ...
          stem: 'What is the counselor’s best immediate response to Naomi’s current presentation?',
          options: [
            'Complete a brief eating-disorder and suicide assessment, offer the nutrition drink, and contact the pediatrician before Naomi leaves if symptoms persist',
            'Ask the parent to take Naomi home for supervised fluids and arrange a next-day pediatric visit because she remains conscious and oriented',
            'Pause counseling, keep Naomi supervised, and coordinate immediate medical evaluation with capacity for laboratory testing, ECG, and hospital admission',
        ...
        },
        {
          ...
          options: [
            'Give the parents access to all eating-related content because they provided consent and must assume responsibility for every meal while Naomi is medically vulnerable',
            'Promise Naomi that private-session content will not be shared unless she reports suicidal intent, because food restriction is already known to her parents',
            'Delay private time until medical stability is restored, since individual confidentiality could allow Naomi to conceal behavior that caregivers need to monitor',
            'Explain the stated rules to everyone, seek Naomi’s assent, define necessary safety and treatment sharing, and preserve privacy beyond those limits',
          ],
          correctAnswer: 3,
          explanation: 'The case supplies the governing policy. Before inviting sensitive information, the counselor explains parental consent, private time, foreseeable safety and treatment disclosures, other exceptions, and caregiver roles. Assent and collaborative planning respect Naomi without pretending that necessary information always remains private. Parental consent does not require disclosure of every psychotherapy detail. A promise limited to suicide risk ignores medical danger and other exceptions. Automatically delaying private time can damage assessment and alliance; privacy can coexist with a clear safety boundary.',
        },
        {
          id: 'exam-03-naomi-q4',
          questionNumber: 4,
          domain: 'Core counseling attributes',
          stem: 'Naomi’s mother says food refusal rejects the family, and Naomi begins to cry. Which response is most appropriate?',
          options: [
            ...
            'Ask Naomi to reassure her mother that she values family meals, because repairing the misunderstanding will reduce guilt enough to improve intake',
            'Meet separately with the mother to examine enmeshment and food-centered expectations before including her in treatment planning with Naomi',
          ],
          correctAnswer: 1,
          explanation: 'The response validates food as family care without treating culture as pathology or proof that Naomi should eat through danger. It separates symptoms from disloyalty and invites effective support. Calling the behavior oppositional assigns motive and dismisses relational meaning. Asking Naomi to reassure her mother burdens Naomi with regulating the parent while neglecting fear and risk. Presuming enmeshment pathologizes the family and delays transparent involvement. Cultural humility explores this family’s meanings and power while keeping nutrition, autonomy, and safety visible.',
        },
      ],
    },
    {
...
At home, Naomi's mother prepares every item as a puree and watches each swallow; her father sometimes threatens loss of phone privileges if Naomi does not finish. Both want recovery. Nutrition currently depends on several tolerated foods and supplements. Naomi says she can consider treatment if no one surprises her with food and if she helps build the steps.` ,
      questions: [
        {
          id: 'exam-03-naomi-q5',
          questionNumber: 5,
        ...
        },
        {
          ...
          stem: 'Which initial outpatient plan is best matched to Naomi’s formulation and recent hospitalization?',
          options: [
            'Start daily solid-food exposure at the top of Naomi’s fear hierarchy while maintaining weekly medical checks, because early disconfirmation prevents chronic avoidance',
        ...
        },
        {
          ...
          options: [
            ...
            'Ask both parents to stop blending, monitoring, and reassurance immediately so natural consequences can expose Naomi to the full cost of continued avoidance at home',
            'Maintain all current accommodations until Naomi reports minimal anxiety, then remove them together to avoid inconsistent expectations between parents',
      ...
      questions: [
        {
          ...
          options: [
            ...
            'Ask Naomi to take a smaller bite of a previously mastered food so avoidance does not become reinforced if the symptom is anxiety',
            'Stop the exposure, follow the emergency protocol, and obtain immediate medical care for possible esophageal obstruction',
            'Have Naomi’s mother transport her to gastroenterology after the session because she can still breathe and speak normally',
          ],
          correctAnswer: 2,
        ...
        },
        {
          ...
          options: [
            ...
            'Resume the original hierarchy after medication starts, because changing exposure targets would confirm that Naomi was correct to distrust anxiety treatment',
            'Suspend all exposure until Naomi has no dysphagia, no anticipatory fear, and unrestricted medical clearance for every major food texture',
          ],
          correctAnswer: 1,
        ...
        {
          id: 'exam-03-naomi-q10',
          questionNumber: 10,
          domain: 'Counseling skills and interventions',
          stem: 'What is the counselor’s best response when Naomi says the impaction proves that clinicians dismissed her body?',
          options: [
