      ...
      questions: [
        {
          ...
          stem: "Samuel describes intrusive harm images, repeated checking, mental review, and reassurance-seeking. Which single feature most reliably distinguishes harm-themed OCD from a prodromal violent ideation requiring emergency action?",
          options: [
            "He denies any past violent acts or arrests.",
            "The thoughts are unwanted, distressing, inconsistent with his stated values, and he engages in neutralizing behavior to reduce — not enact — them.",
            "He has no access to firearms and works in a regulated municipal role.",
            "His wife and sister report he has always been gentle and careful.",
          ],
          correctAnswer: 1,
          explanation: "Ego-dystonicity plus neutralizing compulsions is the defining structural feature of OCD harm obsessions. Absence of past violence, restricted access, and collateral report of character all contribute to risk assessment but can be present in other clinical pictures and do not by themselves rule out emerging risk.",
        },
        {
          id: "samuel-q2",
          questionNumber: 2,
          domain: "Intake/assessment/diagnosis",
          stem: "Samuel reports intrusive images of stabbing a loved one while cooking. What is the most appropriate clinical action at intake?",
          options: [
            "Document the images as ego-dystonic obsessions and move on to ERP psychoeducation so reassurance is not reinforced.",
            "Conduct a structured risk assessment covering intent, urge intensity, command quality, access to means, impulse control, substance use, and psychotic features, then differentiate obsession from ideation.",
            "Treat any harm imagery toward an identified person as a Tarasoff-relevant duty to warn until ruled out by collateral.",
            "Defer detailed inquiry into content so therapeutic alliance is not damaged in session one.",
          ],
          correctAnswer: 1,
          explanation: "Even clearly ego-dystonic obsessions warrant a structured risk assessment at intake to confirm the formulation and document reasoning. Reflexively documenting obsessions without assessment, defaulting to duty-to-warn, or deferring inquiry each fail in opposite directions.",
        },
        {
          id: "samuel-q3",
          questionNumber: 3,
          domain: "Core counseling attributes",
          stem: "Samuel asks, 'You know I would never hurt anyone, right?' What response best maintains alliance without reinforcing reassurance-seeking?",
          options: [
            "I am not going to answer that, because answering would feed the OCD loop.",
            "I notice the urge to ask is showing up right now — can we stay with what it is like to sit with not knowing how I would answer?",
            "What I know is that the thought you cannot stand the most is the one OCD will keep handing you.",
            "Of course — and the fact that you are asking tells me how seriously you take who you want to be.",
          ],
          correctAnswer: 1,
          explanation: "The best response names the in-the-moment compulsion and invites tolerance of uncertainty without reassurance and without lecturing. Refusing to answer can feel punitive; explaining OCD\'s logic intellectualizes; reassurance reinforces the ritual.",
        },
        {
          id: "samuel-q4",
          questionNumber: 4,
          domain: "Treatment planning",
          stem: "Which is the most clinically defensible first behavioral target with Samuel in ERP?",
          options: [
            "Eliminate all stove-checking immediately to break the ritual cycle.",
            "Build a graded exposure hierarchy beginning with lower-distress items and pair each step with response prevention of the linked compulsion.",
            "Begin with imaginal exposure to the harm images before addressing checking rituals, since the obsessions are the core problem.",
            "Defer ERP and use cognitive restructuring of thought-action fusion until belief credibility drops below 50%.",
          ],
          correctAnswer: 1,
          explanation: "Graded hierarchy plus response prevention is the standard ERP protocol. Eliminating rituals abruptly often produces dropout; imaginal exposure can be useful but typically supplements rather than precedes in vivo work; restructuring as a prerequisite delays the active ingredient.",
        },
        {
          id: "samuel-q5",
          questionNumber: 5,
          domain: "Professional practice and ethics",
          stem: "Samuel asks whether he should start medication because ERP sounds difficult. What is the best response?",
          options: [
            "Recommend an SSRI trial since OCD responds well to it and combined treatment is superior.",
            "Discuss that medication evaluation is an evidence-supported option, refer to a prescriber with consent, and clarify that the prescribing decision is not within counselor scope.",
            "Encourage him to attempt ERP first because adding medication can mask exposure learning.",
            "Suggest he ask his PCP for a low-dose SSRI to ease into treatment.",
          ],
          correctAnswer: 1,
          explanation: "Counselors can discuss medication as an option and coordinate referral but cannot recommend specific agents, dosing, or sequencing. The two distractor framings (start an SSRI; delay medication) both step into prescribing territory.",
        },
      ],
    },
    {
