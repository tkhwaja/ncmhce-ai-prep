...
export const desmondUrgentOutpatientReferralNarrative: Narrative = {
  id: 'exam-03-04-desmond-urgent-outpatient-referral',
  title: 'Desmond — Urgent Outpatient Referral',
  ...
  presentingProblem: `You are a licensed mental health counselor in an outpatient clinic specializing in behavioral and substance addictions. Desmond B., a 32-year-old logistics coordinator, accepts a same-day intake after his wife, Lena, discovers extensive sports-betting and online-casino debt. Desmond says he came voluntarily, then adds, “Voluntary is a generous word. She said treatment or she takes the kids.”

Lena found $46,000 in credit-card and personal-loan debt, an $18,000 withdrawal from joint savings, and messages showing that Desmond borrowed $9,500 from his sister. Desmond had told Lena that a payroll error delayed their mortgage payment. He now alternates between admitting the losses and saying one carefully selected parlay could “erase the whole disaster.” He checked live odds twice in the waiting room and has three betting applications open on his phone.
  ...
  sections: [
    {
      ...
      questions: [
        {
          id: 'exam-03-desmond-q1',
          questionNumber: 1,
          domain: 'Counseling skills and interventions',
          stem: 'What is the counselor’s most appropriate next action after Desmond’s statement that there may be little reason to wake up?',
          options: [
        ...
        {
          id: 'exam-03-desmond-q3',
          questionNumber: 3,
          domain: 'Core counseling attributes',
          stem: 'How should the counselor respond when Desmond says that diagnosing a disorder would help him evade moral and family responsibility?',
          options: [
    ...
    },
    {
      ...
      // Recommended pacing: ~8 minutes
      sectionNarrative: `The initial suicide assessment found intermittent thoughts that his family might be better without him but no current plan, intent, preparation, or known lethal-means access. Desmond identified his children as reasons for living, agreed to a written safety plan and frequent contact, and accepted an urgent psychiatric evaluation. Lena drove him home after Desmond authorized only that day’s safety coordination. Disposition was revisited rather than inferred from the screen.

Over the next week, records and interviews clarify the gambling course. During the past 12 months, Desmond has been persistently preoccupied, needed increasing stakes, repeatedly failed to stop, become restless when trying, gambled when distressed, chased losses, lied to conceal the extent, jeopardized marriage and work, and relied on others for bailout money. No distinct manic or hypomanic syndrome is identified. Substance screening is negative, and medical review does not suggest another cause.

Developmental history and collateral do not show conduct disorder before age 15 or a pervasive adult pattern of aggression, irresponsibility, criminality, reckless disregard, or exploitation independent of gambling. Desmond’s deception and misuse of shared funds are serious and require accountability, but the current evidence does not establish a broad personality pattern.

At the third session, circumstances have changed. Lena scheduled a divorce consultation for the following morning and told Desmond he cannot stay in the home tonight. Desmond reveals that yesterday he purchased a handgun, placed it in his car, drafted a note to his children, and selected a parking area where he intends to die after Lena’s appointment. He says he has “about sixty percent intent,” cannot promise not to act, and drank several shots before arriving. He refuses to give the counselor his car key and says, “Do not call Lena. She has had enough of my damage.” His children remain reasons for living, but he says that dying before they understand what happened may protect them from shame.

Desmond is now unable to describe a credible way to remain safe without external intervention. The clinic has access to a mobile crisis team, emergency medical services, and hospital psychiatric evaluation. Any disclosure must follow applicable law, clinic procedure, and the minimum information necessary to reduce danger.`,
      questions: [
        {
          id: 'exam-03-desmond-q5',
          questionNumber: 5,
          domain: 'Intake/assessment/diagnosis',
        ...
        },
        {
          ...
          options: [
            ...
            'Use the mobile crisis team only if Desmond refuses a final collaborative safety plan, because involuntary escalation may intensify shame and treatment avoidance',
          ],
          correctAnswer: 1,
          explanation: 'Desmond now has intent, a specific plan, lethal access, preparation, intoxication, an imminent trigger, and inability to maintain safety independently. He requires continuous observation and emergency psychiatric evaluation, with secure transport and active lethal-means intervention. Collaboration and voluntary care remain preferable when feasible, but another safety-plan negotiation is not an adequate substitute at this level of acute risk. Lena may help reduce danger, yet she should not be made the decision maker or asked to retrieve a firearm before emergency systems are activated. The counselor may disclose minimum necessary information to capable supports or responders as permitted by law and policy; Desmond’s request for secrecy does not override the immediate protection obligation.',
        },
        {
          id: 'exam-03-desmond-q7',
          questionNumber: 7,
          domain: 'Treatment planning',
          stem: 'Assuming Desmond is stabilized and discharged, which step-down plan best matches the full formulation?',
          options: [
            ...
            'Use weekly individual counseling and Gamblers Anonymous while Lena controls finances, increasing intensity only if Desmond gambles or becomes suicidal again',
          ],
          correctAnswer: 0,
        ...
        {
          id: 'exam-03-desmond-q8',
          questionNumber: 8,
          domain: 'Intake/assessment/diagnosis',
          stem: 'How should Desmond’s deception and misuse of shared funds affect assessment for Antisocial Personality Disorder?',
          options: [
...
Treatment includes motivational work, gambling-specific CBT, trigger and urge management, peer meetings, application and website blocking, formal self-exclusion where available, and a financial counselor. With Desmond’s agreement, paychecks enter an account used for essential bills, new credit is frozen, and he receives a defined personal amount. Lena has access to agreed financial records but is not made responsible for detecting every urge. Desmond returns to work with restricted phone access during shifts. No further suicidal intent or preparation is reported.

After seven gambling-free weeks, Desmond discovers that a prediction-market platform is not blocked and wagers $420 following an argument with Lena. He stops before chasing the loss, tells Lena and the counselor within 12 hours, and closes the account. Lena says the lapse proves all privacy is dangerous. She requests every therapy note, a list of anything Desmond has said about money, and permanent access to his phone. Desmond authorizes one partner consultation limited to safety planning, broad treatment goals, and their collaborative financial agreement; he does not authorize release of psychotherapy content or records. The relationship remains individual counseling, not couples therapy.

During the consultation, Lena says, “I cannot consent to staying married if you know financial secrets and hide behind confidentiality.” Desmond responds, “One bet means I am exactly who I was. They might be better off collecting the life insurance before I drain everything again.” He looks down and will not initially clarify whether this is a new suicide thought.`,
      questions: [
        {
          id: 'exam-03-desmond-q9',
          questionNumber: 9,
          domain: 'Treatment planning',
          stem: 'How should the lapse be incorporated into Desmond’s treatment plan?',
          options: [
            ...
            'Return Desmond to the intensive program’s first phase because severe gambling after a suicidal crisis makes any lapse evidence of insufficient stabilization',
          ...
          correctAnswer: 1,
          explanation: 'The lapse supplies actionable information without erasing seven weeks of recovery. Functional analysis identifies the trigger, access failure, decision points, consequences, and protective acts; the plan can reinforce stopping, rapid disclosure, and account closure while strengthening barriers, coping, financial safeguards, and suicide monitoring. Lena needs protection and choice, but making her the permanent surveillance system burdens the relationship and does not build Desmond’s recovery. A higher level of care may be needed if recurrence, loss of control, or risk warrants it, not automatically after one contained event. Controlled gambling should not be adopted reflexively because shame emerged; the treatment goal remains a collaborative, risk-informed decision.',
        },
        {
          id: 'exam-03-desmond-q10',
          questionNumber: 10,
          domain: 'Professional practice and ethics',
          ...
          options: [
            ...
            'Adopt a no-secrets policy for the remainder of treatment and allow Desmond to decide whether to accept it before the next individual session',
            ...
            'End the consultation and refer the couple elsewhere because Lena’s request creates an unavoidable conflict between Desmond’s confidentiality and her financial safety',
          ],
          correctAnswer: 2,
          explanation: 'Lena’s need for informed financial boundaries is legitimate, but it does not give her automatic access to Desmond’s records or individual-session content. The counselor should stay within the specific authorization, facilitate voluntary disclosure tied to the financial agreement, and help Lena make decisions using information Desmond consents to share. A no-secrets policy cannot be imposed retroactively on prior individual disclosures. If the clinician later assumes a couples role, the clients need new informed consent about who the client is, records, contact, secrets, and foreseeable consequences. Referral is not automatically required; the roles can remain clear. Acute safety exceptions remain available when their legal criteria are met, but ordinary financial risk does not erase confidentiality.',
        },
        {
          id: 'exam-03-desmond-q11',
          questionNumber: 11,
          domain: 'Counseling skills and interventions',
          stem: 'What should the counselor do first after Desmond says his family may be better off collecting his life insurance?',
          options: [
            ...
            'Ask Lena whether the statement resembles Desmond’s prior crisis, using her answer to determine whether the established safety plan should be activated',
            'Challenge the all-or-nothing interpretation by contrasting the contained lapse with Desmond’s recent recovery, then reassess suicide risk if hopelessness remains',
            'Invite Desmond to use his urge-management sequence while Lena identifies immediate financial boundaries that could restore his sense of control',
          ],
          correctAnswer: 0,
          explanation: 'The life-insurance statement is new suicide-relevant content in a client with a recent high-acute-risk episode. Safety assessment again takes precedence over relapse processing, reassurance, couples work, or financial problem solving. The counselor should ask Desmond directly about current ideation, intent, planning, access, preparation, substance use, and ability to maintain safety, then choose disposition from the findings. Lena’s observations are useful but cannot replace Desmond’s direct assessment or make her responsible for triage. Cognitive and relapse interventions may follow if the client can safely engage. Improvement and a contained lapse do not justify assuming that the statement is merely shame-based or rhetorical.',
        },
      ],
    },
  ],
