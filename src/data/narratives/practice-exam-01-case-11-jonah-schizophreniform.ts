      ...
      questions: [
        {
          ...
          correctAnswer: 0,
          explanation: `Schizophreniform Disorder is defined by schizophrenia-spectrum symptoms lasting at least one month but less than six months. Shame, family history, and spirituality are relevant but not diagnostic.`,
        },
        {
          id: `jonah-q2`,
          questionNumber: 2,
          domain: `Professional practice and ethics`,
          stem: `His mother calls asking what he said in therapy because she is paying tuition and wants to keep him safe. What is the best response?`,
          options: [
            `Provide a brief summary because family involvement reduces relapse risk`,
            `Decline to disclose clinical information without his authorization while inviting her to share safety concerns she wants you to know`,
            `Tell her that Jonah refused parent contact`,
            `Share only whether he is medication-adherent because safety is involved`,
          ],
          correctAnswer: 1,
          explanation: `Jonah is an adult. Family concern and tuition payment do not authorize disclosure. The counselor may receive collateral information without revealing protected information.`,
        },
        {
          id: `jonah-q3`,
          questionNumber: 3,
          domain: `Core counseling attributes`,
          stem: `Jonah says prayer and treatment should not be treated as enemies. What is the best therapeutic stance?`,
          options: [
            `Support spiritual practices that are grounding while helping him distinguish them from beliefs that intensify paranoia or psychosis`,
            `Encourage him to avoid prayer until psychosis is fully remitted`,
            `Tell him spiritual explanations are part of the illness and should be challenged`,
            `Recommend he choose medical treatment over spiritual interpretations`,
          ],
          correctAnswer: 0,
          explanation: `A culturally responsive stance respects spirituality while maintaining reality-based care and avoiding reinforcement of delusional interpretations.`,
        },
        {
          id: `jonah-q4`,
          questionNumber: 4,
          domain: `Treatment planning`,
          stem: `What is the best first-phase counseling focus after recent discharge for first-episode psychosis?`,
          options: [
            `Stabilization, symptom monitoring, sleep protection, medication adherence support, reality testing, and coordinated specialty care`,
            `Detailed analysis of the hidden-message beliefs to prove they were not real`,
            `Immediate trauma processing of the hospitalization`,
            `Insight-oriented exploration of family privacy and perfectionism`,
          ],
          correctAnswer: 0,
          explanation: `Early post-discharge care should prioritize stabilization, relapse prevention, sleep, coordinated care, medication adherence, and gentle reality testing. Confrontation or deep exploratory work too early can destabilize.`,
        },
          ],
          correctAnswer: 1,
      ...
      questions: [
        {
          ...
          correctAnswer: 1,
          explanation: `Counselors should not adjust medication or minimize side effects. The appropriate role is to support prescriber communication and monitor functioning, adherence, and symptoms.`,
        },
        {
          id: `jonah-q6`,
          questionNumber: 6,
          domain: `Professional practice and ethics`,
          stem: `Jonah wants his parents involved for practical support but does not want them given every therapy detail. What should be done?`,
          options: [
            `Use a limited, purpose-specific release identifying what may be shared and what remains private`,
            `Refuse parent involvement because he is an adult`,
            `Share broad updates as long as delusional content is not discussed`,
            `Require a family session before any information is shared`,
          ],
          correctAnswer: 0,
          explanation: `A limited release protects autonomy while enabling useful support. Adult status does not prohibit family involvement, but consent and boundaries are required.`,
        },
        {
          id: `jonah-q7`,
          questionNumber: 7,
          domain: `Professional practice and ethics`,
          stem: `A professor requests a “clearance letter” saying Jonah is safe to return and able to manage stress. What is the best response?`,
          options: [
            `Write the letter to reduce stigma and support reentry`,
            `Decline all communication with faculty because academic documentation is outside counseling`,
            `Clarify what documentation is needed, obtain authorization, and avoid fitness-for-duty or safety guarantees outside scope`,
            `State that he is safe as long as he remains medication-compliant`,
          ],
          correctAnswer: 2,
          explanation: `Counselors should avoid broad safety or fitness-for-duty guarantees. Any documentation should be narrow, accurate, authorized, and within scope.`,
        },
        {
          id: `jonah-q8`,
          questionNumber: 8,
          domain: `Treatment planning`,
          stem: `One brief night of reduced sleep frightens him because sleep loss preceded hospitalization. What is the most appropriate clinical interpretation?`,
          options: [
            `It is an early warning sign to monitor and respond to according to his relapse-prevention plan, but not proof of relapse`,
            `It indicates relapse is starting and requires immediate rehospitalization`,
            `It is irrelevant because hallucinations have remitted`,
            `It suggests Bipolar Disorder is more likely than Schizophreniform Disorder`,
          ],
          correctAnswer: 0,
          explanation: `Sleep disruption is a key early warning sign, but one night does not prove relapse. The response should reinforce monitoring and prevention rather than panic or dismissal.`,
        },
          ],
          correctAnswer: 1,
      ...
      questions: [
        {
          ...
          correctAnswer: 0,
          explanation: `Remission of positive symptoms is not the end of recovery. Ongoing work should support relapse prevention, identity, functioning, supports, and coordination.`,
        },
        {
          id: `jonah-q10`,
          questionNumber: 10,
          domain: `Counseling skills and interventions`,
          stem: `A friend invites him to a weekend where cannabis will likely be present and says, “One hit isn’t going to break your brain.” What is the best intervention?`,
          options: [
            `Advise him not to attend any event where cannabis may be present`,
            `Review substance-related relapse risk after psychosis and create a concrete plan for declining use, managing pressure, and leaving if needed`,
            `Tell him cannabis is acceptable if he remains medication-compliant`,
            `Focus on whether the friendship is emotionally supportive enough`,
          ],
          correctAnswer: 1,
          explanation: `Cannabis can increase relapse risk after psychosis. A practical, specific plan is more useful than blanket avoidance or minimizing risk.`,
        },
        {
          id: `jonah-q11`,
          questionNumber: 11,
          domain: `Core counseling attributes`,
          stem: `Jonah asks how to talk about recovery without becoming “a walking diagnosis.” What is the most therapeutic response?`,
          options: [
            `“You should disclose only to people who have earned that level of trust.”`,
            `“What would it look like for this episode to be part of your story without becoming your whole identity?”`,
            `“Psychosis is serious, so minimizing it could increase relapse risk.”`,
            `“You do not have to tell friends anything if you are not ready.”`,
          ],
          correctAnswer: 1,
          explanation: `The response supports identity integration without prescribing disclosure or non-disclosure. It helps him build a recovery narrative that honors the episode without reducing him to it.`,
        },
          ],
          correctAnswer: 1,
