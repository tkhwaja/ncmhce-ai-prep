      ...
      questions: [
        {
          ...
          correctAnswer: 1,
          explanation: 'GAD is characterized by excessive, hard-to-control worry occurring more days than not across multiple life domains, accompanied by physical and cognitive symptoms. Wedding stress, somatic symptoms, and conscientiousness alone do not establish the diagnosis.',
        },
        {
          id: 'neha-q2',
          questionNumber: 2,
          ...
          options: [
            '"Then you should start saying no more often."',
            '"It sounds like either choice carries a cost for you right now."',
            '"Your family is asking too much of you."',
            '"Let’s focus on practical scheduling solutions."',
          ],
          correctAnswer: 1,
          explanation: 'A reflective response captures the client’s genuine dilemma without taking sides or rushing prematurely into advice. Directing, blaming the family, or bypassing the emotional conflict weakens the alliance and misses the core struggle.',
        },
        {
          id: 'neha-q3',
          questionNumber: 3,
          ...
          options: [
            ...
            'CBT focused on worry monitoring, psychoeducation, and differentiating worry from problem-solving',
            'Immediate exploration of childhood attachment trauma',
            'Supportive therapy without structure to reduce pressure',
          ],
          correctAnswer: 1,
          explanation: 'A CBT approach is evidence-based for GAD and is especially appropriate in the first phase of treatment, when clients benefit from psychoeducation, symptom monitoring, and a clearer understanding of the worry cycle. ERP is first-line for OCD, not GAD. Unstructured support alone is insufficient for a chronic, functionally impairing presentation.',
        },
        {
          id: 'neha-q4',
          questionNumber: 4,
          domain: 'Intake/assessment/diagnosis',
          stem: 'The client reports occasional chest tightness when her phone rings late at night but denies discrete panic attacks. How should this be understood diagnostically?',
          options: [
            'As evidence that Panic Disorder is primary',
            'As likely episodic physiological anxiety within the broader pattern of generalized worry',
            'As proof the symptoms are purely medical',
            'As a sign of obsessive-compulsive disorder',
          ],
          correctAnswer: 1,
          explanation: 'Brief spikes of physiological anxiety can occur within GAD, especially when worry is triggered by meaningful cues. Panic Disorder requires recurrent unexpected panic attacks and persistent fear or behavior change related to them; that pattern is not present here.',
        },
      ],
    },
    {
