                ...
                <div className="mt-2 grid grid-cols-2 gap-3 text-sm">
                  {c.items.map((it: any, j: number) => (
                    <div key={j}>
                      ...
                      <p className="text-xs text-muted-foreground leading-relaxed">{it.definition}</p>
                    </div>
                  ))}
                </div>
                {c.keyTakeaway && (
                  <p className="mt-3 rounded bg-muted px-3 py-2 text-xs text-foreground leading-relaxed">{c.keyTakeaway}</p>
                )}
              </CardContent>
            </Card>
          ))}
